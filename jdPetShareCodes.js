...
let PetShareCodes = [
  'MTAxODcxOTI2NTAwMDAwMDAwNTkyNTk2OQ==@MTAxODc2NTEzOTAwMDAwMDAzMTgwMjkyMw==',//账号一的好友shareCode,不同好友中间用@符号隔开
  'MTAxODc2NTEzNTAwMDAwMDAwMDA3NjcxNw==@MTAxODc2NTEzOTAwMDAwMDAzMTgwMjkyMw==',//账号二的好友shareCode，不同好友中间用@符号隔开
]
