...
hlyyurl  task/doTasks 请求链接即为所需要的数据
hlyyhd   task/doTasks 请求的头部数据即为所需要的数据 JSON格式
hlyybody task/doTasks 请求的头部数据即为所需要的数据 JSON格式

变量 HLCK  格式 url 换行 header 换行 body
